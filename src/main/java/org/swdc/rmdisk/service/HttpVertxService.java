...
import org.swdc.rmdisk.service.verticle.VertxHttpVerticle;

import java.util.function.Consumer;

public class HttpVertxService extends Dynamic {
    ...
    private VertxHttpVerticle verticle;
    ...
    public void startService(Consumer<Boolean> callback) {
        ...
        if (verticle == null) {
            ...
            verticle = getByType(VertxHttpVerticle.class);
            verticle.setPort(Integer.parseInt(config.getPort()));
